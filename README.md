...
Current settings on my Logitech C920 on Debian 10 stable.
...
$ v4l2-ctl --device=0 --list-ctrls
 ...
 white_balance_temperature_auto 0x0098090c (bool)   : default=1 value=1
                           gain 0x00980913 (int)    : min=0 max=255 step=1 default=0 value=33
           power_line_frequency 0x00980918 (menu)   : min=0 max=2 default=2 value=1
      white_balance_temperature 0x0098091a (int)    : min=2000 max=6500 step=1 default=4000 value=2800 flags=inactive
